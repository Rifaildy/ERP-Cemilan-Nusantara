...
export default function PenerimaanBahan({ setCurrentPage, currentPage }) {
  ...
  const menuItems = [
    ...
    { icon: Package, label: "Stok Bahan Baku", page: "stok-bahan", active: currentPage === "stok-bahan" },
    {
      icon: ShoppingCart,
      label: "Purchase Order (PO)",
      page: "purchase-order",
      active: currentPage === "purchase-order",
    },
    { icon: Truck, label: "Penerimaan Barang", page: "penerimaan-bahan", active: currentPage === "penerimaan-bahan" },
    { icon: ClipboardList, label: "Retur Supplier", page: "retur-bahan", active: currentPage === "retur-bahan" },
  ]
