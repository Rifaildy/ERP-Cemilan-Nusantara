...
export default function AnalisisFIFO({ setCurrentPage, currentPage }) {
  ...
  const menuItems = [
    ...
    { icon: BarChart3, label: "Laporan Inventory", page: "laporan-stok" },
    { icon: ShoppingCart, label: "Approval PO", page: "approval-po" },
    { icon: FileText, label: "Analisis FIFO", page: "analisis-fifo" },
    { icon: Users, label: "Manajemen Supplier", page: "supplier" },
  ]
