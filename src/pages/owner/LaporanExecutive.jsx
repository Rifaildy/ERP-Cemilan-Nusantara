...
export default function LaporanExecutive({ setCurrentPage }) {
  const menuItems = [
  ...
  return (
    <DashboardLayout menuItems={menuItems} currentPage="laporan-executive" setCurrentPage={setCurrentPage}>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Laporan Executive</h1>
          ...
          <div className="flex gap-2">
            ...
            <button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">Ekspor Laporan</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow p-6 text-white">
            <div className="text-blue-100 text-sm mb-1">Pendapatan</div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow p-6 text-white">
            <div className="text-green-100 text-sm mb-1">Laba Kotor</div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow p-6 text-white">
            <div className="text-purple-100 text-sm mb-1">Laba Bersih</div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow p-6 text-white">
            <div className="text-orange-100 text-sm mb-1">Saldo Kas</div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Metrik Operasional</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-gray-700">Pesanan Penjualan</span>
                <span className="text-gray-900 font-bold">{totalOrders}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-gray-700">Pesanan Produksi</span>
                <span className="text-gray-900 font-bold">{totalProduction}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-gray-700">Pesanan Pembelian</span>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Rasio Keuangan</h3>
            <div className="space-y-3">
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="text-gray-600 text-sm">Margin Laba Kotor</div>
                <div className="text-2xl font-bold text-gray-900">{grossProfitMargin}%</div>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="text-gray-600 text-sm">Rasio Lancar</div>
                <div className="text-2xl font-bold text-gray-900">{currentRatio}</div>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <div className="text-gray-600 text-sm">Rasio Hutang</div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Rincian Pendapatan</h3>
            <div className="space-y-3">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Rincian Beban</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h3 className="text-lg font-bold text-gray-800 mb-4">Tren Kinerja Bulanan</h3>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-bold text-yellow-800 mb-1">Perhatian Diperlukan</div>
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• 3 bahan baku akan kedaluwarsa dalam 30 hari</li>
                  <li>
                    • Piutang tertunggak: Rp {invoices.reduce((sum, i) => sum + i.sisa, 0).toLocaleString("id-ID")}
                  </li>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-bold text-green-800 mb-1">Status Sistem</div>
