...
export default function ReturBahan() {
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <div className="flex items-center space-x-3">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(retur.status)}`}>
                        {retur.status}
                      </span>
                    </div>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-2xl font-bold text-red-600">Rp {retur.totalNilai.toLocaleString("id-ID")}</div>
                  </div>
                </div>
