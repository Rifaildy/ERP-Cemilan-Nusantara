...
import { LayoutDashboard, BarChart3, Settings, FileText, Lightbulb } from "lucide-react"

export default function ResepProduk({ setCurrentPage, currentPage }) {
  ...
  const menuItems = [
    ...
    { icon: FileText, label: "Formula & Resep", page: "resep-produk" },
    { icon: Settings, label: "Master Data Produk", page: "master-produk" },
  ]
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="bg-green-50 p-3 rounded-lg">
                      ...
                      <div className="text-lg font-bold text-green-600">
                        Rp {resep.hargaJual.toLocaleString("id-ID")}
                      </div>
                    </div>
