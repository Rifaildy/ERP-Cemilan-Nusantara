...
import { LayoutDashboard, BarChart3, ShoppingCart, FileText, Users } from "lucide-react"

export default function LaporanStok({ setCurrentPage, currentPage }) {
  ...
  const menuItems = [
    ...
    { icon: BarChart3, label: "Laporan Inventory", page: "laporan-stok", active: currentPage === "laporan-stok" },
    { icon: ShoppingCart, label: "Approval PO", page: "approval-po", active: currentPage === "approval-po" },
    { icon: FileText, label: "Analisis FIFO", page: "analisis-fifo", active: currentPage === "analisis-fifo" },
    { icon: Users, label: "Manajemen Supplier", page: "supplier", active: currentPage === "supplier" },
  ]
