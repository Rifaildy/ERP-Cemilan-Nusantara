...
export default function AnalisisKinerja({ setCurrentPage }) {
  const menuItems = [
  ...
  return (
    <DashboardLayout menuItems={menuItems} currentPage="analisis-kinerja" setCurrentPage={setCurrentPage}>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">Ekspor Analisis</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-gray-600 text-sm mb-2">Perputaran Inventori</div>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="text-center mb-3">
                <div className="text-gray-600 text-sm mb-1">Margin Laba Kotor</div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="text-center mb-3">
                <div className="text-gray-600 text-sm mb-1">Margin Operasional</div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="text-center mb-3">
                <div className="text-gray-600 text-sm mb-1">Margin Laba Bersih</div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Kinerja Penjualan</h3>
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="text-gray-600 mb-2">Pelanggan Teratas</div>
                <div className="flex justify-between items-center">
                  <div>
                    <div className="font-medium text-gray-900">{topCustomer.nama}</div>
                    <div className="text-sm text-gray-500">{topCustomer.orders} pesanan</div>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-blue-600">
                      Rp {topCustomer.total.toLocaleString("id-ID")}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Kinerja Produksi</h3>
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-600">Total Pesanan Produksi</span>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-500">
                  {((completedProduction.length / pesananProduksi.length) * 100).toFixed(1)}% tingkat penyelesaian
                </div>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-600">Rata-rata Efisiensi</span>
        ...
        {/* Cost Structure */}
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-bold text-gray-800 mb-4">Analisis Struktur Biaya</h3>
